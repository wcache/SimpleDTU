...
采用`LTE-OPEN-EVB`开发板搭载`EC600N-CN-TEA`模组。

![](./images/dev_board2.png)

> 注意事项：
>
> 1. 将`EC600N-CN-TE-A`模组卡入底座中。
> 2. 在SIM卡座中插入SIM卡。
> 3. 连接COM(MAIN)口至PC。
> 4. 使用USB连接开发板至电脑USB接口供电。
...
<img src="./images/EC2X.png" style="zoom: 33%;" />

> 注意事项：
>
> 1. 在SIM卡座中插入SIM卡。
> 2. 接入天线。
> 3. 使用Type-C转USB数据线连接开发板至电脑USB接口。
